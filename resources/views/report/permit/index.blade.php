...
<body>
    ...
    <div class="arial container">
        ...
        <br>
        <br>
        <div class="center barangayHeaderStyle" ><b>BUSINESS PERMIT</b></div>
        <br><br><br><br><br>

        <div class="toWhomStyle"><b>TO WHOM IT MAY CONCERN</b></div>
        <p style="line-height:1.5"><b>
            {{-- {!! $purpose !!} --}}
            This is to certify that Mr ./Ms. /Mrs. <u>NAME</u> whose signature appears below, legal age,
            married/single Filipino and a bonafide resident of <u>ADDRESS</u> is known to me personally to be 
            a person of good moral character, peaceful, and lawabiding citizen and that he/she has no derogatory 
            records as fas as this barangay is concerned. 
        </b>
        </p>
